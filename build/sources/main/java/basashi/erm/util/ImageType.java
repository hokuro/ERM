...
public class ImageType {
	...
	JPEG	="jpg",BMP	="bmp",GIF="gif",PNG="png",TIFF	="tif",PICT	="pic",
	UNKNOWN	="UNKNOWN";

	public static enum Format{
		JPEG(ImageType.JPEG),BMP(ImageType.BMP),GIF(ImageType.GIF),PNG(ImageType.PNG),TIFF(ImageType.TIFF),PICT(ImageType.PICT),
