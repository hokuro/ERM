...
public ResourceLocation getArmorTextureName(int index, ItemStack itemstack){
	if ( itemstack == null == !(itemstack.func_77973_b() instanceof ItemArmor)) return null;
	int renderIndex = ((ItemArmor)itemstack.func_77973_b()).field_77880_c;
	int l = 0;
	if (itemstack.func_77958_k() > 0){
		l = (10 * itemstack.func_77952_i() / itemstack.func_77958_k());
	}

	if (armors.isEmpty() || itemstack == null) return null;
	if(!(itemstack.func_77973_b() instanceof ItemArmor)) return null;
