...
public class ERMModelPlate extends ERMModelBoxBase {
	 ...
	 */
	public ERMModelPlate(ERMModelRenderer pMRenderer, Object... pArg) {
	...
	private void init(ERMModelRenderer modelrenderer, int pTextureX, int pTextureY,
	...
	public float getU(ERMModelRenderer pRender, int pU) {
		float lf = (float)pU / pRender.textureWidth;
		return lf;
	}

	public float getV(ERMModelRenderer pRender, int pV) {
