...
public class GuiTextureSlot extends GuiSlot {
	...
	public int selected;
	public List<Integer> texDress;
	public List<Integer> texArmor;
	public boolean mode;
...
//		bloankBox.models = new ModelERMBase[]{null, null, null};
		...
		texsel[0] = 0;
		texsel[1] = 0;
		texDress = new ArrayList<Integer>();
		texArmor = new ArrayList<Integer>();
...
//		}
	...
	protected int getSize(){
		return 0;//mode ? texArmor.size() : texDress.size();
	}
